#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# Build the Supply Chain 360 container image and push it to a Snowflake image
...
#
# The image is pushed to:  <registry_host>/<repo_path>/supply_chain_360:latest
# ---------------------------------------------------------------------------
set -euo pipefail
...
IMAGE="${REGISTRY_HOST}/${REPO_PATH}/supply_chain_360:latest"
